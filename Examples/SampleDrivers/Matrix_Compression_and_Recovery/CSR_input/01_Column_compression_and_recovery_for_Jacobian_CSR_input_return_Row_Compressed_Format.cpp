...
int main()
{
  ...
  double ***dp3_Value =
      new double **; // dp3_ means double pointers of type double. Other prefixes follow the same notation
  ...
  BipartiteGraphPartialColoringInterface *g =
      new BipartiteGraphPartialColoringInterface(SRC_MEM_CSR, *ip_RowIndex, rowCount, columnCount, *ip_ColumnIndex);
