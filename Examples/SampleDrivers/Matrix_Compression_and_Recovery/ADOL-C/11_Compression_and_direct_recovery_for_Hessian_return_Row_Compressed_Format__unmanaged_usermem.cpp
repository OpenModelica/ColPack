...
int main()
{
  ...
  *ip1_ColorCount = *ip1_SeedColumnCount;
  ...
  int rowCount_for_dp3_NewValue =
      hr->DirectRecover_RowCompressedFormat_unmanaged(g, *dp3_CompressedMatrix, *uip3_SparsityPattern, dp3_NewValue);
  ...
  if (CompressedRowMatricesAreEqual(*dp3_Value, *dp3_NewValue, rowCount, 0, 1))
