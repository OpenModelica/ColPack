...
int main()
{
  ...
  *ip1_ColorCount = *ip1_SeedColumnCount;
  ...
  int i_arraySize = hr->DirectRecover_SparseSolversFormat(g, *dp3_CompressedMatrix, *uip3_SparsityPattern, ip2_RowIndex,
                                                          ip2_ColumnIndex, dp2_HessianValue);
  cout << "Finish Recover()" << endl;

  cout << endl
       << "Display result, the structure and values should be similar to the upper half of the original matrix" << endl;
