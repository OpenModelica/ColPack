...
const unordered_set<string> GENERAL_COLORING({"DISTANCE_ONE", "ACYCLIC", "ACYCLIC_FOR_INDIRECT_RECOVERY", "STAR",
                                              "RESTRICTED_STAR", "DISTANCE_TWO"});
const unordered_set<string> BICOLORING({"IMPLICIT_COVERING__STAR_BICOLORING", "EXPLICIT_COVERING__STAR_BICOLORING",
                                        "EXPLICIT_COVERING__MODIFIED_STAR_BICOLORING",
                                        "IMPLICIT_COVERING__GREEDY_STAR_BICOLORING"});
const unordered_set<string> PARTIAL_COLORING({"COLUMN_PARTIAL_DISTANCE_TWO", "ROW_PARTIAL_DISTANCE_TWO"});
...
void partial_coloring(int argc, char *argv[])
{
  ...
  for (auto fname : fnames)
  {
    BipartiteGraphPartialColoringInterface *g =
        new BipartiteGraphPartialColoringInterface(0, fname.c_str(), "AUTO_DETECTED");
    for (auto m : methds)
    {
      for (auto o : orders)
      {
...
void usage()
{
  fprintf(
      ...
      "\n"
      "DESCRIPTION\n"
      "       the ColPack application shall take a list of commands and do the graph coloring. And display the results "
      "to the screen.\n"
      "       There are some specific commands for different methods. Find more details on "
      "'https://github.com/ProbShin/ColPack'\n"
      "\n"
      "OPTIONS\n"
      ...
      "       -o orders   Indicates the orderings. Could be "
      "'RANDOM','NATURAL','LARGEST_FIRST','SMALLEST_LAST','DYNAMIC_LARGEST_FIRST','INCIDENCE_DEGREE'... . There could "
      "be some specific ordering for specific methods\n"
      "       -m methods  Indicates the methods. Could be "
      "'DISTANCE_ONE','ACYCLIC','STAR','DISTNACE_TWO','ROW_PARTIAL_DISTANCE_TWO','D1_OMP_GMMP','PD2_OMP_GMMP',...\n"
      ...
      "\n"
      "DESCRIPTION\n"
      "       if the method is one of 'DISTANCE_ONE','ACYCLIC','STAR','DISTANCE_TWO','ROW_PARTIAL_DISTANCE_TWO' The "
      "method belongs to gereral coloring on general graphs.\n"
      "       if the method is one of 'ROW_PARTIAL_DISTANCE_TWO','COLUMN_PARTIAL_DISTANCE_TWO' The method belongs to "
      "partial coloring on bipartite graphs.\n"
      "       if the method is one of "
      "'IMPLICIT_COVERING__STAR_BICOLORING','EXPLICIT_COVERING__STAR_BICOLORING',EXPLICIT_COVERING__MODIFIED_STAR_"
      "BICOLORING','IMPLICIT_COVERING__GREEDY_STAR_BICOLORING'. The method belongs to bicoloring on bipartite graphs.\n"
      "       if the method is one of 'D1_OMP_GM3P, D1_OMP_GM3P_LF, D1_OMP_GMMP, D1_OMP_GMMP_LF,D1_OMP_SERIAL, "
      "D1_OMP_SERIAL_LF, D1_OMP_JP, D1_OMP_JP_LF ,D1_OMP_MTJP, D1_OMP_MTJP_LF, D1_OMP_HBJP_GM3P, D1_OMP_HBJP_GM3P_.., "
      "D1_OMP_HBJP_GMMP.., D1_OMP_HBJP_.... ,D1_OMP_HBMTP_GM3P, D1_OMP_HBMTJP_GM3P_.., D1_OMP_HBMTJP_GMMP.., "
      "D1_OMP_HBMTJP_.... ,D2_OMP_GM3P, D2_OMP_GM3P_LF ,D2_OMP_GMMP, D2_OMP_GMMP_LF ,D2_OMP_SERIAL, D2_OMP_SERIAL_LF' "
      "the method belongs to parallel general graph coloring\n"
      "\n"
      "EXAMPLE\n"
