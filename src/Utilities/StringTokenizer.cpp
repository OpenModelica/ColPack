...
string StringTokenizer::GetDelimiterString() const { return (DelimiterString); }
...
string StringTokenizer::GetInputString() const { return (InputString); }
...
int StringTokenizer::HasMoreTokens() { return (CountTokens()); }
