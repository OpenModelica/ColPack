...
*/
int MatrixDeallocation_SparseSolversFormat(unsigned int **ip2_RowIndex, unsigned int **ip2_ColumnIndex,
...
*/
int MatrixDeallocation_CoordinateFormat(unsigned int **ip2_RowIndex, unsigned int **ip2_ColumnIndex,
                                        double **dp2_HessianValue);

template <typename T> int free_2DMatrix(T **dp2_2DMatrix, unsigned int i_numOfRows)
{
...
template <typename T> int free_2DMatrix(T ***dp3_2DMatrix, unsigned int i_numOfRows)
{
