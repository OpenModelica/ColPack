...
public: // Constructions
  ...
  SMPGCColoring(const string &graph_name, const string &fmt, double *iotime = nullptr, const string &ord = "NATURAL",
...
public: // API
  ...
  int D1_OMP_HBJP(int nT, int &color, vector<int> &vtxColors, const int option = HYBRID_SERIAL,
                  const int swtich_iter = 0, const int local_order = ORDER_NONE);
  int D1_OMP_HBMTJP(int nT, int &color, vector<int> &vtxColors, const int option = HYBRID_SERIAL,
                    const int switch_iter = 0, const int local_order = ORDER_NONE);
  ...
  inline void hybrid_GM3P(const int nT, vector<int> &vtxColors, vector<vector<int>> &Q,
                          const int local_order = ORDER_NONE);
  inline void hybrid_GMMP(const int nT, vector<int> &vtxColors, vector<vector<int>> &Q,
                          const int local_order = ORDER_NONE);
