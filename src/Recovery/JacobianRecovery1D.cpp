...
int JacobianRecovery1D::RecoverD2Row_RowCompressedFormat_unmanaged(BipartiteGraphPartialColoringInterface *g,
  ...
  *dp3_JacobianValue = (double **)malloc(rowCount * sizeof(double *));
  for (unsigned int i = 0; i < (unsigned int)rowCount; i++)
  {
    ...
    for (size_t j = 1; j <= numOfNonZeros; j++)
      (*dp3_JacobianValue)[i][j] = 0.; // initialize value of other entries
  }

  return RecoverD2Row_RowCompressedFormat_usermem(g, dp2_CompressedMatrix, uip2_JacobianSparsityPattern,
                                                  dp3_JacobianValue);
}

int JacobianRecovery1D::RecoverD2Row_RowCompressedFormat_usermem(BipartiteGraphPartialColoringInterface *g,
                                                                 double **dp2_CompressedMatrix,
                                                                 unsigned int **uip2_JacobianSparsityPattern,
                                                                 double ***dp3_JacobianValue)
{
...
int JacobianRecovery1D::RecoverD2Row_RowCompressedFormat(BipartiteGraphPartialColoringInterface *g,
                                                         double **dp2_CompressedMatrix,
                                                         unsigned int **uip2_JacobianSparsityPattern,
                                                         double ***dp3_JacobianValue)
{
  int returnValue = RecoverD2Row_RowCompressedFormat_unmanaged(g, dp2_CompressedMatrix, uip2_JacobianSparsityPattern,
                                                               dp3_JacobianValue);
...
int JacobianRecovery1D::RecoverD2Row_SparseSolversFormat_usermem(BipartiteGraphPartialColoringInterface *g,
                                                                 double **dp2_CompressedMatrix,
                                                                 unsigned int **uip2_JacobianSparsityPattern,
                                                                 ...
                                                                 double **dp2_JacobianValue)
{
  ...
  for (unsigned int i = 0; i < (unsigned int)rowCount; i++)
  {
    ...
    {
      (*dp2_JacobianValue)[(*ip2_RowIndex)[i] + j - 1] =
          dp2_CompressedMatrix[vi_LeftVertexColors[i]][uip2_JacobianSparsityPattern[i][j]];
    }
  }
...
int JacobianRecovery1D::RecoverD2Row_SparseSolversFormat_unmanaged(BipartiteGraphPartialColoringInterface *g,
                                                                   double **dp2_CompressedMatrix,
                                                                   unsigned int **uip2_JacobianSparsityPattern,
                                                                   unsigned int **ip2_RowIndex,
                                                                   unsigned int **ip2_ColumnIndex,
                                                                   double **dp2_JacobianValue)
{
  ...
  for (unsigned int i = 0; i < numOfNonZeros; i++)
    (*dp2_JacobianValue)[i] = 0.; // initialize value of other entries

  return RecoverD2Row_SparseSolversFormat_usermem(g, dp2_CompressedMatrix, uip2_JacobianSparsityPattern, ip2_RowIndex,
                                                  ip2_ColumnIndex, dp2_JacobianValue);
}

int JacobianRecovery1D::RecoverD2Row_SparseSolversFormat(BipartiteGraphPartialColoringInterface *g,
                                                         double **dp2_CompressedMatrix,
                                                         unsigned int **uip2_JacobianSparsityPattern,
                                                         unsigned int **ip2_RowIndex, unsigned int **ip2_ColumnIndex,
                                                         double **dp2_JacobianValue)
{
  int returnValue = RecoverD2Row_SparseSolversFormat_unmanaged(g, dp2_CompressedMatrix, uip2_JacobianSparsityPattern,
                                                               ip2_RowIndex, ip2_ColumnIndex, dp2_JacobianValue);
...
int JacobianRecovery1D::RecoverD2Row_CoordinateFormat_usermem(BipartiteGraphPartialColoringInterface *g,
                                                              double **dp2_CompressedMatrix,
                                                              unsigned int **uip2_JacobianSparsityPattern,
                                                              unsigned int **ip2_RowIndex,
                                                              unsigned int **ip2_ColumnIndex,
                                                              double **dp2_JacobianValue)
{
  ...
  */
  ...
  for (unsigned int i = 0; i < (unsigned int)rowCount; i++)
  {
    ...
    for (int j = 1; j <= numOfNonZeros; j++)
    {
      (*dp2_JacobianValue)[numOfNonZeros_count] =
          dp2_CompressedMatrix[vi_LeftVertexColors[i]][uip2_JacobianSparsityPattern[i][j]];
...
*/
int JacobianRecovery1D::RecoverD2Row_CoordinateFormat_unmanaged(BipartiteGraphPartialColoringInterface *g,
                                                                double **dp2_CompressedMatrix,
                                                                unsigned int **uip2_JacobianSparsityPattern,
                                                                unsigned int **ip2_RowIndex,
                                                                unsigned int **ip2_ColumnIndex,
                                                                double **dp2_JacobianValue)
{
  ...
  return RecoverD2Row_CoordinateFormat_usermem(g, dp2_CompressedMatrix, uip2_JacobianSparsityPattern, ip2_RowIndex,
                                               ip2_ColumnIndex, dp2_JacobianValue);
}
/*
...
*/
int JacobianRecovery1D::RecoverD2Row_CoordinateFormat(BipartiteGraphPartialColoringInterface *g,
                                                      double **dp2_CompressedMatrix,
                                                      unsigned int **uip2_JacobianSparsityPattern,
                                                      unsigned int **ip2_RowIndex, unsigned int **ip2_ColumnIndex,
                                                      double **dp2_JacobianValue)
{
  int returnValue = RecoverD2Row_CoordinateFormat_unmanaged(g, dp2_CompressedMatrix, uip2_JacobianSparsityPattern,
                                                            ip2_RowIndex, ip2_ColumnIndex, dp2_JacobianValue);
...
int JacobianRecovery1D::RecoverD2Cln_ADICFormat(BipartiteGraphPartialColoringInterface *g,
                                                double **dp2_CompressedMatrix,
...
int JacobianRecovery1D::RecoverD2Cln_RowCompressedFormat_usermem(BipartiteGraphPartialColoringInterface *g,
                                                                 double **dp2_CompressedMatrix,
                                                                 unsigned int **uip2_JacobianSparsityPattern,
                                                                 double ***dp3_JacobianValue)
{
...
int JacobianRecovery1D::RecoverD2Cln_RowCompressedFormat_unmanaged(BipartiteGraphPartialColoringInterface *g,
                                                                   double **dp2_CompressedMatrix,
                                                                   unsigned int **uip2_JacobianSparsityPattern,
                                                                   double ***dp3_JacobianValue)
{
  ...
  *dp3_JacobianValue = (double **)malloc(rowCount * sizeof(double *));
  ...
  return RecoverD2Cln_RowCompressedFormat_usermem(g, dp2_CompressedMatrix, uip2_JacobianSparsityPattern,
                                                  dp3_JacobianValue);
}

int JacobianRecovery1D::RecoverD2Cln_RowCompressedFormat(BipartiteGraphPartialColoringInterface *g,
                                                         double **dp2_CompressedMatrix,
                                                         unsigned int **uip2_JacobianSparsityPattern,
                                                         double ***dp3_JacobianValue)
{
  int returnValue = RecoverD2Cln_RowCompressedFormat_unmanaged(g, dp2_CompressedMatrix, uip2_JacobianSparsityPattern,
                                                               dp3_JacobianValue);
...
int JacobianRecovery1D::RecoverD2Cln_SparseSolversFormat_usermem(BipartiteGraphPartialColoringInterface *g,
                                                                 double **dp2_CompressedMatrix,
                                                                 unsigned int **uip2_JacobianSparsityPattern,
                                                                 unsigned int **ip2_RowIndex,
                                                                 unsigned int **ip2_ColumnIndex,
                                                                 double **dp2_JacobianValue)
{
  ...
  for (unsigned int i = 0; i < (unsigned int)rowCount; i++)
  {
    ...
    {
      (*dp2_JacobianValue)[(*ip2_RowIndex)[i] + j - 1] =
          dp2_CompressedMatrix[i][vi_RightVertexColors[uip2_JacobianSparsityPattern[i][j]]];
    }
  }
...
int JacobianRecovery1D::RecoverD2Cln_SparseSolversFormat_unmanaged(BipartiteGraphPartialColoringInterface *g,
                                                                   double **dp2_CompressedMatrix,
                                                                   unsigned int **uip2_JacobianSparsityPattern,
                                                                   unsigned int **ip2_RowIndex,
                                                                   unsigned int **ip2_ColumnIndex,
                                                                   double **dp2_JacobianValue)
{
  ...
  return RecoverD2Cln_SparseSolversFormat_usermem(g, dp2_CompressedMatrix, uip2_JacobianSparsityPattern, ip2_RowIndex,
                                                  ip2_ColumnIndex, dp2_JacobianValue);
}

int JacobianRecovery1D::RecoverD2Cln_SparseSolversFormat(BipartiteGraphPartialColoringInterface *g,
                                                         double **dp2_CompressedMatrix,
                                                         unsigned int **uip2_JacobianSparsityPattern,
                                                         unsigned int **ip2_RowIndex, unsigned int **ip2_ColumnIndex,
                                                         double **dp2_JacobianValue)
{
  int returnValue = RecoverD2Cln_SparseSolversFormat_unmanaged(g, dp2_CompressedMatrix, uip2_JacobianSparsityPattern,
                                                               ip2_RowIndex, ip2_ColumnIndex, dp2_JacobianValue);
...
int JacobianRecovery1D::RecoverD2Cln_CoordinateFormat_usermem(BipartiteGraphPartialColoringInterface *g,
                                                              double **dp2_CompressedMatrix,
                                                              unsigned int **uip2_JacobianSparsityPattern,
                                                              unsigned int **ip2_RowIndex,
                                                              unsigned int **ip2_ColumnIndex,
...
*/
int JacobianRecovery1D::RecoverD2Cln_CoordinateFormat_unmanaged(BipartiteGraphPartialColoringInterface *g,
                                                                double **dp2_CompressedMatrix,
                                                                unsigned int **uip2_JacobianSparsityPattern,
                                                                unsigned int **ip2_RowIndex,
                                                                unsigned int **ip2_ColumnIndex,
                                                                double **dp2_JacobianValue)
{
  ...
  return RecoverD2Cln_CoordinateFormat_usermem(g, dp2_CompressedMatrix, uip2_JacobianSparsityPattern, ip2_RowIndex,
                                               ip2_ColumnIndex, dp2_JacobianValue);
}
/*
...
*/
int JacobianRecovery1D::RecoverD2Cln_CoordinateFormat(BipartiteGraphPartialColoringInterface *g,
                                                      double **dp2_CompressedMatrix,
                                                      unsigned int **uip2_JacobianSparsityPattern,
                                                      unsigned int **ip2_RowIndex, unsigned int **ip2_ColumnIndex,
                                                      double **dp2_JacobianValue)
{
  int returnValue = RecoverD2Cln_CoordinateFormat_unmanaged(g, dp2_CompressedMatrix, uip2_JacobianSparsityPattern,
                                                            ip2_RowIndex, ip2_ColumnIndex, dp2_JacobianValue);
...
int JacobianRecovery1D::CompareMatrix_CoordinateFormat_vs_CoordinateFormat(
    int i_rowCount, unsigned int **ip2_RowIndex, unsigned int **ip2_ColumnIndex, double **dp2_JacobianValue,
    unsigned int **ip2_RowIndex2, unsigned int **ip2_ColumnIndex2, double **dp2_JacobianValue2)
{
  ...
  for (int i = 0; i < i_rowCount; i++)
  {
    ...
    {
      cout << "i=" << i << " (*ip2_RowIndex)[i] (" << (*ip2_RowIndex)[i] << ")!=(*ip2_RowIndex2)[i] ("
           << (*ip2_RowIndex2)[i] << ")" << endl;
      fail_flag = true;
      break;
    }
    ...
    {
      cout << "i=" << i << " (*ip2_ColumnIndex)[i] (" << (*ip2_ColumnIndex)[i] << ")!=(*ip2_ColumnIndex2)[i] ("
           << (*ip2_ColumnIndex2)[i] << ")" << endl;
      fail_flag = true;
      break;
    }
    ...
    {
      cout << "i=" << i << " (*dp2_JacobianValue)[i] (" << (*dp2_JacobianValue)[i] << ")!=(*dp2_JacobianValue2)[i] ("
           << (*dp2_JacobianValue2)[i] << ")" << endl;
      fail_flag = true;
      break;
    }
  }
...
int JacobianRecovery1D::CompareMatrix_CoordinateFormat_vs_RowCompressedFormat(
    int i_rowCount, unsigned int **ip2_RowIndex, unsigned int **ip2_ColumnIndex, double **dp2_JacobianValue,
    int rowCount2, unsigned int ***uip3_SparsityPattern, double ***dp3_Value)
{
  bool fail_flag = false;
  for (int i = 0; i < i_rowCount; i++)
  {
    ...
    {
      if ((*uip3_SparsityPattern)[(*ip2_RowIndex)[i]][j] == (*ip2_ColumnIndex)[i])
        break;
    }
    ...
    {
      cout << "i=" << i << " (*dp2_JacobianValue)[i] (" << (*dp2_JacobianValue)[i] << ")!=(*dp3_Value)["
           << (*ip2_RowIndex)[i] << "][" << (*ip2_ColumnIndex)[i] << "] (" << (*dp3_Value)[(*ip2_RowIndex)[i]][j] << ")"
           << endl;
      fail_flag = true;
      break;
    }
