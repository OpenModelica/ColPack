...
int JacobianRecovery2D::DirectRecover_RowCompressedFormat_usermem(BipartiteGraphBicoloringInterface *g,
                                                                  ...
                                                                  double ***dp3_JacobianValue)
{
  ...
  if (g->GetRightVertexDefaultColor() == 1)
    i_ColumnColorCount--; // color ID 0 is used, ignore it
  ...
  for (unsigned int i = 0; i < (unsigned int)rowCount; i++)
  {
    ...
    for (unsigned int j = 0; j < (unsigned int)i_ColumnColorCount; j++)
  ...
  for (unsigned int i = 0; i < (unsigned int)rowCount; i++)
  {
    ...
    for (unsigned int j = 1; j <= numOfNonZeros; j++)
    {
          ...
          colorStatistic[i][RightVertexColors_Transformed[uip2_JacobianSparsityPattern[i][j]] - 1] == 1)
      {
        ...
        (*dp3_JacobianValue)[i][j] =
            dp2_ColumnCompressedMatrix[i][RightVertexColors_Transformed[uip2_JacobianSparsityPattern[i][j]] - 1];
      }
      else
      { // If not, then use dp2_RowCompressedMatrix
        ...
        (*dp3_JacobianValue)[i][j] =
            dp2_RowCompressedMatrix[vi_LeftVertexColors[i] - 1][uip2_JacobianSparsityPattern[i][j]];
      }
    }
  }
  // cout<<"DONE"<<endl;
...
int JacobianRecovery2D::DirectRecover_RowCompressedFormat_unmanaged(BipartiteGraphBicoloringInterface *g,
                                                                    double **dp2_RowCompressedMatrix,
                                                                    double **dp2_ColumnCompressedMatrix,
                                                                    unsigned int **uip2_JacobianSparsityPattern,
                                                                    double ***dp3_JacobianValue)
{
  ...
  *dp3_JacobianValue = (double **)malloc(rowCount * sizeof(double *));
  ...
  return DirectRecover_RowCompressedFormat_usermem(g, dp2_RowCompressedMatrix, dp2_ColumnCompressedMatrix,
                                                   uip2_JacobianSparsityPattern, dp3_JacobianValue);
}

int JacobianRecovery2D::DirectRecover_RowCompressedFormat(BipartiteGraphBicoloringInterface *g,
                                                          double **dp2_RowCompressedMatrix,
                                                          double **dp2_ColumnCompressedMatrix,
                                                          unsigned int **uip2_JacobianSparsityPattern,
                                                          double ***dp3_JacobianValue)
{
  int returnValue = DirectRecover_RowCompressedFormat_unmanaged(g, dp2_RowCompressedMatrix, dp2_ColumnCompressedMatrix,
                                                                uip2_JacobianSparsityPattern, dp3_JacobianValue);
...
int JacobianRecovery2D::DirectRecover_SparseSolversFormat_usermem(
    BipartiteGraphBicoloringInterface *g, double **dp2_RowCompressedMatrix, double **dp2_ColumnCompressedMatrix,
    unsigned int **uip2_JacobianSparsityPattern, unsigned int **ip2_RowIndex, unsigned int **ip2_ColumnIndex,
...
int JacobianRecovery2D::DirectRecover_SparseSolversFormat_unmanaged(
    BipartiteGraphBicoloringInterface *g, double **dp2_RowCompressedMatrix, double **dp2_ColumnCompressedMatrix,
    unsigned int **uip2_JacobianSparsityPattern, unsigned int **ip2_RowIndex, unsigned int **ip2_ColumnIndex,
    double **dp2_JacobianValue)
{
  ...
  return DirectRecover_SparseSolversFormat_usermem(g, dp2_RowCompressedMatrix, dp2_ColumnCompressedMatrix,
                                                   uip2_JacobianSparsityPattern, ip2_RowIndex, ip2_ColumnIndex,
                                                   dp2_JacobianValue);
}

int JacobianRecovery2D::DirectRecover_SparseSolversFormat(BipartiteGraphBicoloringInterface *g,
                                                          double **dp2_RowCompressedMatrix,
                                                          double **dp2_ColumnCompressedMatrix,
                                                          unsigned int **uip2_JacobianSparsityPattern,
                                                          ...
                                                          double **dp2_JacobianValue)
{
  int returnValue = DirectRecover_SparseSolversFormat_unmanaged(g, dp2_RowCompressedMatrix, dp2_ColumnCompressedMatrix,
                                                                uip2_JacobianSparsityPattern, ip2_RowIndex,
...
int JacobianRecovery2D::DirectRecover_CoordinateFormat_usermem(
    BipartiteGraphBicoloringInterface *g, double **dp2_RowCompressedMatrix, double **dp2_ColumnCompressedMatrix,
    unsigned int **uip2_JacobianSparsityPattern, unsigned int **ip2_RowIndex, unsigned int **ip2_ColumnIndex,
    double **dp2_JacobianValue)
{
...
int JacobianRecovery2D::DirectRecover_CoordinateFormat_unmanaged(
    BipartiteGraphBicoloringInterface *g, double **dp2_RowCompressedMatrix, double **dp2_ColumnCompressedMatrix,
    unsigned int **uip2_JacobianSparsityPattern, unsigned int **ip2_RowIndex, unsigned int **ip2_ColumnIndex,
    double **dp2_JacobianValue)
{
  ...
  return DirectRecover_CoordinateFormat_usermem(g, dp2_RowCompressedMatrix, dp2_ColumnCompressedMatrix,
                                                uip2_JacobianSparsityPattern, ip2_RowIndex, ip2_ColumnIndex,
                                                dp2_JacobianValue);
}

int JacobianRecovery2D::DirectRecover_CoordinateFormat(BipartiteGraphBicoloringInterface *g,
                                                       double **dp2_RowCompressedMatrix,
                                                       double **dp2_ColumnCompressedMatrix,
                                                       unsigned int **uip2_JacobianSparsityPattern,
                                                       unsigned int **ip2_RowIndex, unsigned int **ip2_ColumnIndex,
                                                       double **dp2_JacobianValue)
{
  int returnValue = DirectRecover_CoordinateFormat_unmanaged(g, dp2_RowCompressedMatrix, dp2_ColumnCompressedMatrix,
                                                             uip2_JacobianSparsityPattern, ip2_RowIndex,
                                                             ip2_ColumnIndex, dp2_JacobianValue);
