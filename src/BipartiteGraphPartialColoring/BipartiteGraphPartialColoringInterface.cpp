...
void BipartiteGraphPartialColoringInterface::GenerateSeedJacobian(double ***dp3_seed, int *ip1_SeedRowCount,
...
void BipartiteGraphPartialColoringInterface::GenerateSeedJacobian_unmanaged(double ***dp3_seed, int *ip1_SeedRowCount,
                                                                       ...
                                                                       string s_ColoringVariant)
{
  ...
  {
    cout << " Unknown Partial Distance Two Coloring Method " << s_ColoringVariant << ". Please use a legal Method."
         << endl;
    m_T_Timer.Stop();
