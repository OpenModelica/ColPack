...
public: // DOCUMENTED
  ...
  */
  int PartialDistanceTwoColoring(string s_OrderingVariant = "NATURAL",
  ...
  */
  void GenerateSeedJacobian(double ***dp3_seed, int *ip1_SeedRowCount, int *ip1_SeedColumnCount,
  ...
  */
  void GenerateSeedJacobian_unmanaged(double ***dp3_seed, int *ip1_SeedRowCount, int *ip1_SeedColumnCount,
                                      string s_OrderingVariant = "NATURAL",
                                      string s_ColoringVariant = "COLUMN_PARTIAL_DISTANCE_TWO");
