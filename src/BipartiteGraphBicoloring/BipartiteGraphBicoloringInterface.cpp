...
void BipartiteGraphBicoloringInterface::GenerateSeedJacobian(double ***dp3_LeftSeed, int *ip1_LeftSeedRowCount,
                                                             int *ip1_LeftSeedColumnCount, double ***dp3_RightSeed,
                                                             int *ip1_RightSeedRowCount, int *ip1_RightSeedColumnCount,
                                                             string s_OrderingVariant, string s_BicoloringVariant)
{
...
void BipartiteGraphBicoloringInterface::GenerateSeedJacobian_unmanaged(
    double ***dp3_LeftSeed, int *ip1_LeftSeedRowCount, int *ip1_LeftSeedColumnCount, double ***dp3_RightSeed,
    int *ip1_RightSeedRowCount, int *ip1_RightSeedColumnCount, string s_OrderingVariant, string s_BicoloringVariant)
{
...
double **BipartiteGraphBicoloringInterface::GetRightSeedMatrix(int *ip1_RightSeedRowCount,
