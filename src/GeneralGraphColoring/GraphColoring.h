...
public:
  ...
  int PrintStarCollection(vector<int> &vi_EdgeStarMap, vector<int> &vi_StarHubMap,
   ...
   */
  int DetectConflictInColorCombination(int i_MaxNumThreads, int i_thread_num, pair<int, int> pii_ColorCombination,
  ...
  int BuildStarFromColorCombination(int i_MaxNumThreads, int i_thread_num, pair<int, int> pii_ColorCombination,
                                    map<pair<int, int>, Colors2Edge_Value, lt_pii> *Colors2Edge_Private,
                                    map<int, vector<pair<int, int>>> *Vertex2ColorCombination_Private,
                                    map<int, int> *PotentialHub_Private);
   ...
   */
  int BuildVertex2ColorCombination(int i_MaxNumThreads,
                                   map<int, vector<pair<int, int>>> *Vertex2ColorCombination_Private,
  ...
  int BuildStarFromColorCombination_forChecking(int i_Mode, int i_MaxNumThreads, int i_thread_num,
                                                pair<int, int> pii_ColorCombination,
                                                map<pair<int, int>, Colors2Edge_Value, lt_pii> *Colors2Edge_Private,
                                                map<int, int> *PotentialHub_Private);
  int BuildForbiddenColors(int i_MaxNumThreads, int i_thread_num, int i_CurrentVertex,
  ...
  int PrintVertexAndColorAdded(int i_MaxNumThreads, vector<pair<int, int>> *vi_VertexAndColorAdded,
                               int i_LastNEntries = 999999999);
  int PrintForbiddenColors(map<int, bool> *mip_ForbiddenColors, int i_thread_num);
  int PickVerticesToBeRecolored(int i_MaxNumThreads, vector<pair<int, int>> *ConflictedEdges_Private,
                                vector<int> &ConflictCount);
  int PrintAllColorCombination(map<pair<int, int>, Colors2Edge_Value, lt_pii> *Colors2Edge_Private, int i_MaxNumThreads,
                               int i_MaxNumOfCombination = 1000000, int i_MaxElementsOfCombination = 100000);
  int PrintColorCombination(map<pair<int, int>, Colors2Edge_Value, lt_pii> *Colors2Edge_Private, int i_MaxNumThreads,
                            pair<int, int> pii_ColorCombination, int i_MaxElementsOfCombination = 100000);
  ...
  int PrintVertex2ColorCombination(int i_MaxNumThreads,
                                   map<int, vector<pair<int, int>>> *Vertex2ColorCombination_Private);
  ...
  /** Sample code:
          ...
          delete graph;
   */
  int BuildSubGraph(map<int, map<int, bool>> *graph, int i_CenterVertex, int distance = 1,
                    map<int, bool> *mib_FilterByColors = NULL);

  /** Sample code: (see function int BuildSubGraph() )
   */
  int BuildConnectedSubGraph(map<int, map<int, bool>> *graph, int i_CenterVertex, int distance = 1,
                             map<int, bool> *mib_FilterByColors = NULL);
