...
public: // DOCUMENTED
  ...
  */
  void GenerateSeedHessian(double ***dp3_seed, int *ip1_SeedRowCount, int *ip1_SeedColumnCount,
                           string s_OrderingVariant = "NATURAL", string s_ColoringVariant = "STAR");
  ...
  */
  void GenerateSeedHessian_unmanaged(double ***dp3_seed, int *ip1_SeedRowCount, int *ip1_SeedColumnCount,
                                     string s_OrderingVariant = "NATURAL", string s_ColoringVariant = "STAR");
  ...
  static void PrintInducedVertexDegrees(int SetID, int i_HighestInducedVertexDegree,
                                        vector<list<int>> &vli_GroupedInducedVertexDegrees);

  static void PrintVertexEdgeMap(vector<int> &vi_Vertices, vector<int> &vi_Edges,
